...
/*   Updated: 2023/09/30 11:31:11 by yuboktae         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_cmd_info(t_cmd_info *cmd_info, t_env *env, t_parse_list *s);
static void	execute_exit(t_parse_list *s, t_table *main, t_cmd_info *cmd_info);
		...
		t_table *main, t_cmd_info *cmd_info)
{
	...
	execute_exit(parse_list, main, cmd_info);
	tmp_fd[0] = dup(STDIN_FILENO);
	tmp_fd[1] = dup(STDOUT_FILENO);
	flag_redir = handle_redirections(parse_list, main, cmd_info, tmp_fd);
