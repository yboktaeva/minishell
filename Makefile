...
#    Updated: 2023/08/29 18:54:23 by yuboktae         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES	=	main/minishell.c main/main.c init/init_all.c lexer/get_env.c\
				...
				parser/build_parse.c parser/parse_analyse.c execution/cmd_path.c \
				execution/path_utils.c execution/one_cmd_exec.c \
				...
				destructor/free_env.c utils/utils.c	utils/env_utils.c
